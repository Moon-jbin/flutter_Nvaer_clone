...
class MallItemsOne extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: List.generate(
          _controller.mallItemsPageOne.length,
          (index) => MallItemsTitle(
                name: _controller.mallItemsPageOne[index]["name"],
                image1: _controller.mallItemsPageOne[index]["image1"],
                image2: _controller.mallItemsPageOne[index]["image2"],
                image3: _controller.mallItemsPageOne[index]["image3"],
                title1: _controller.mallItemsPageOne[index]["title1"],
                title2: _controller.mallItemsPageOne[index]["title2"],
                title3: _controller.mallItemsPageOne[index]["title3"],
                subTitle1: _controller.mallItemsPageOne[index]["subTitle1"],
                subTitle2: _controller.mallItemsPageOne[index]["subTitle2"],
                subTitle3: _controller.mallItemsPageOne[index]["subTitle3"],
              )),
    );
  }
}
